...
ActiveRecord::Schema.define(version: 2020_05_10_085314) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["follower_id", "follow_user_id"], name: "index_follows_on_follower_id_and_follow_user_id", unique: true
  end
